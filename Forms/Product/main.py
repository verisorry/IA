...
def run_pdf(task_id: TaskID, qp_input_path: str, ms_input_path: str, output_format: str) -> None:
    ...
    #start process for question paper
...
#threading stuff and logging tasks
...
if __name__ == "__main__":
    ...
    if os_req == True:
        ...
        console.print("Please check your past paper file location again, there should be a new folder containing all the cropped and sorted individual images of questions/answers!\n\n")
